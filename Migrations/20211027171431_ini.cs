        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    N_Referencia_Pandape = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Tipo_de_vaga = table.Column<int>(type: "int", nullable: false),
                    Email_Solicitante = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Filial_RH = table.Column<int>(type: "int", nullable: false),
                    Solicitação_Infra = table.Column<int>(type: "int", nullable: false),
                    Solicitação_Telefonia = table.Column<int>(type: "int", nullable: false),
                    Tipo_Equipamento = table.Column<int>(type: "int", nullable: false),
                    ...
                    Filial_infra = table.Column<int>(type: "int", nullable: false),
                    Movidesk_Infra = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Movidesk_Telefonia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Andamento = table.Column<int>(type: "int", nullable: false),
                    Recebido_por = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DataRecebimento = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Serie_equipamento = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
